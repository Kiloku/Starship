...
CosmeticEditorElement cosmeticEditorElements[COSMETIC_ELEMENT_MAX] = {
    ...
    COSMETIC_EDITOR_DERIVED_ELEMENT(COSMETIC_ELEMENT_FOX_RADAR_COLOR_DARK, "Radar (Star Fox)", "Fox (Dark)", "Radar.Fox_Dark", 89, 121, 6, 128, COSMETIC_ELEMENT_FOX_RADAR_COLOR, 0.5f),
    COSMETIC_EDITOR_ELEMENT(COSMETIC_ELEMENT_FALCO_RADAR_COLOR, "Radar (Star Fox)", "Falco", "Radar.Falco", 90, 90, 255, 255),
    COSMETIC_EDITOR_DERIVED_ELEMENT(COSMETIC_ELEMENT_FALCO_RADAR_COLOR_DARK, "Radar (Star Fox)", "Falco (Dark)", "Radar.Falco_Dark", 45, 45, 128, 128, COSMETIC_ELEMENT_FALCO_RADAR_COLOR, 0.5f),
    COSMETIC_EDITOR_ELEMENT(COSMETIC_ELEMENT_PEPPY_RADAR_COLOR, "Radar (Star Fox)", "Peppy", "Radar.Peppy", 255, 30, 0, 255),
    COSMETIC_EDITOR_DERIVED_ELEMENT(COSMETIC_ELEMENT_PEPPY_RADAR_COLOR_DARK, "Radar (Star Fox)", "Peppy (Dark)", "Radar.Peppy_Dark", 128, 15, 0, 128, COSMETIC_ELEMENT_PEPPY_RADAR_COLOR, 0.5f),
    COSMETIC_EDITOR_ELEMENT(COSMETIC_ELEMENT_SLIPPY_RADAR_COLOR, "Radar (Star Fox)", "Slippy", "Radar.Slippy", 0, 179, 67, 255),
    COSMETIC_EDITOR_DERIVED_ELEMENT(COSMETIC_ELEMENT_SLIPPY_RADAR_COLOR_DARK, "Radar (Star Fox)", "Slippy (Dark)", "Radar.Slippy_Dark", 0, 90, 34, 128, COSMETIC_ELEMENT_SLIPPY_RADAR_COLOR, 0.5f),

    COSMETIC_EDITOR_ELEMENT(COSMETIC_ELEMENT_WOLF_RADAR_COLOR, "Radar (Star Wolf)", "Wolf", "Radar.Wolf", 0, 0, 0, 255),
    COSMETIC_EDITOR_ELEMENT(COSMETIC_ELEMENT_LEON_RADAR_COLOR, "Radar (Star Wolf)", "Leon", "Radar.Leon", 0, 0, 0, 255),
    COSMETIC_EDITOR_ELEMENT(COSMETIC_ELEMENT_PIGMA_RADAR_COLOR, "Radar (Star Wolf)", "Pigma", "Radar.Pigma", 0, 0, 0, 255),
    COSMETIC_EDITOR_ELEMENT(COSMETIC_ELEMENT_ANDREW_RADAR_COLOR, "Radar (Star Wolf)", "Andrew", "Radar.Andrew", 0, 0, 0, 255),
};
